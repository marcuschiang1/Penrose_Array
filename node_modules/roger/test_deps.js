/**
 * @license  Common JS Helpers on OpenTok 0.2.0 8973ea0 master
 * http://www.tokbox.com/
 *
 * Copyright (c) 2014 TokBox, Inc.
 *
 * Date: August 17 11:03:10 2014
 *
 */
...
(function(window, OTHelpers, undefined) {
  ...
  /* test-code */
  if (!OTHelpers.__testonly__) OTHelpers.__testonly__ =  {};
  OTHelpers.__testonly__.disableCapabilityMemorisation = false;
  ...
  memoriseCapabilityTest = function (name, callback) {
    rawCapabilities[name.toLowerCase()] = callback;
  ...
  testCapability = function (name) {
    ...
    if (OTHelpers.__testonly__.disableCapabilityMemorisation === true) {
      cap = rawCapabilities[name];
    }
    else {
  ...
  OTHelpers.__testonly__.resetCapabilities = function() {
    rawCapabilities = {};
    capabilities = {};
  };
  /* end-test-code */
...
/**
 * @license  TB Plugin 0.4.0.7 4e9bca3 develop
 * http://www.tokbox.com/
 *
 * Copyright (c) 2014 TokBox, Inc.
 *
 * Date: August 17 11:03:13 2014
 *
 */
...
/* jshint globalstrict: true, strict: false, undef: true, unused: true,
          trailing: true, browser: true, smarttabs:true */
/* global OT:true, OTPlugin:true, pluginInfo:true, debug:true, scope:true,
          _document:true */
...
var injectObject = function injectObject (mimeType, isVisible, params, completion) {
  var callbackId = 'OTPlugin_loaded_' + generatePluginUuid();
  ...
  scope[callbackId] = function() {
    ...
    pluginRefCounted.onReady(function(err) {
      ...
      if (completion && OT.$.isFunction(completion)) {
        completion.call(OTPlugin, null, pluginRefCounted);
      }
    });
  };
...
/* jshint globalstrict: true, strict: false, undef: true, unused: true,
          trailing: true, browser: true, smarttabs:true */
/* global OT:true, OTPlugin:true, MediaStream:true, RTCStatsReport:true */
...
/* jshint globalstrict: true, strict: false, undef: true, unused: true,
          trailing: true, browser: true, smarttabs:true */
/* global OT:true, OTPlugin:true, pluginInfo:true, ActiveXObject:true,
...
/* global ActiveXObject, OT, OTPlugin, scope, shim,
          PeerConnection, VideoContainer, MediaStream, pluginIsReady:true,
          mediaCaptureObject, plugins, createMediaCaptureController,
          createPeerController, removeAllObjects, AutoUpdater,
          PluginRumorSocket, MediaConstraints */
